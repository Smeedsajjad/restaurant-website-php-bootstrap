...
if (isset($_POST['delete_category'])) {
    ...
    if ($categoryController->deleteCategory($category_id)) {
        // Deletion successful
        // Refresh the categories list
        $categories = $categoryController->getCategories();
        // Success message in toast with checkmark icon and progress bar
        echo "
        <div class='toast align-items-center text-bg-success position-fixed top-0 end-0 m-3' role='alert' aria-live='assertive' aria-atomic='true' id='successToast' style='min-width: 300px;'>
            <div class='d-flex'>
                <div class='toast-body'>
                    ...
                    </span>Category deleted successfully!
        ...
        <div class='toast align-items-center text-bg-danger position-fixed top-0 end-0 m-3' role='alert' aria-live='assertive' aria-atomic='true' id='errorToast' style='min-width: 300px;'>
            <div class='d-flex'>
                <div class='toast-body'>
                    ...
                    </span> Failed to delete category.
                    <div class='progress mt-2'>
                        <div class='progress-bar bg-light' role='progressbar' style='width: 100%' aria-valuenow='100' aria-valuemin='0' aria-valuemax='100'></div>
                    </div>
                </div>
                ...
                <?php foreach ($categories as $category): ?>
                    <div class="col-md-12 menage-cat-card  col-lg-6 col-xl-4 p-0 m-2">
                        ...
                        <div class="content" style="width: 100%;">
                            <!-- Responsive Image -->
                            <img src="<?php echo $category['cat_img']; ?>" class="content-image card-img-top img-fluid" alt="">
                            <!-- Card Body -->
                            <div class="content-details fadeIn-bottom ">
                                ...
                                <span class="card-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="10px" width="10px" viewBox="0 0 448 512" data-toggle="tooltip" data-placement="top" title="Delete" onclick="confirmDelete(<?php echo $category['id']; ?>)" style="cursor: pointer;">
                                        <path d="M135.2 17.7L128 32 32 32C14.3 32 0 46.3 0 64S14.3 96 32 96l384 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-96 0-7.2-14.3C307.4 6.8 296.3 0 284.2 0L163.8 0c-12.1 0-23.2 6.8-28.6 17.7zM416 128L32 128 53.2 467c1.6 25.3 22.6 45 47.9 45l245.8 0c25.3 0 46.3-19.7 47.9-45L416 128z" />
                                    </svg>
                                </span>
                                <span class="card-icon">
                                    <a href="index.php?page=edit-category&id=<?php echo $category['id']; ?>" data-toggle="tooltip" data-placement="top" title="Edit">
                                        <svg height="10px" width="10px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <div class="p-2 mt-2">
                            <h5 class="card-title"><?php echo $category['cat_name']; ?></h5>
                            <p class="card-text"><?php echo $category['created_at']; ?></p>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
