...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $name = $_POST['cat_name'];
    $imagePath = $category['cat_img']; // Keep the existing image path by default

    // Handle image upload logic here
    if (isset($_FILES['cat_img']) && $_FILES['cat_img']['error'] == 0) {
        $targetDir = './uploads/categories/';
        $imageName = basename($_FILES['cat_img']['name']);
    ...
    if ($categoryController->updateCategory($categoryId, $name, $imagePath)) {
        ...
        <div class='toast align-items-center text-bg-success position-fixed top-0 end-0 m-3' role='alert' aria-live='assertive' aria-atomic='true' id='successToast' style='min-width: 300px;'>
            <div class='d-flex'>
                <div class='toast-body'>
                    ...
                    </span>Category updated successfully!
        ...
        <div class='toast align-items-center text-bg-danger position-fixed top-0 end-0 m-3' role='alert' aria-live='assertive' aria-atomic='true' id='errorToast' style='min-width: 300px;'>
            <div class='d-flex'>
                <div class='toast-body'>
                    ...
                    </span> Failed to update category.
                    <div class='progress mt-2'>
                        <div class='progress-bar bg-light' role='progressbar' style='width: 100%' aria-valuenow='100' aria-valuemin='0' aria-valuemax='100'></div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="content-header">
                    ...
                    <form method="post" enctype="multipart/form-data" action="index.php?page=edit-category&id=<?php echo isset($category['id']) ? htmlspecialchars($category['id']) : ''; ?>">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="categoryname" class="form-label">Name</label>
                                    <input name="cat_name" list="categories" value="<?php echo $category['cat_name']; ?>" placeholder="Category Name" type="text" class="form-control my-input" id="categoryname" aria-describedby="emailHelp">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input name="cat_img" type="file" class="form-control my-input" id="categoryimg" aria-describedby="emailHelp" accept="image/*">
                                    <input type="hidden" name="current_cat_img" value="<?php echo htmlspecialchars($category['cat_img']); ?>">
                                    <div id="imagePreview" style="margin-top: 15px;">
                                    <?php if (!empty($category['cat_img'])): ?>
                                            <img src="<?php echo htmlspecialchars($category['cat_img']); ?>" alt="Current Category Image" style="max-width: 300px;">
                                        <?php endif; ?>
                                   </div>
                                </div>
                                <div class="m-1">
