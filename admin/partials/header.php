    ...
    <div class="nav-header">
      <a href="../../restaurant-website-php-bootstrap/admin/index.php" class="brand-logo">
        ...
        <img class="logo-compact" src="https://koki.dexignzone.com/xhtml/images/logo-text.png" alt="" />
        <img class="brand-title" src="https://koki.dexignzone.com/xhtml/images/logo-text.png" alt="" />
      </a>
            ...
            <ul class="navbar-nav header-right">
                        ...
                        <div class="timeline-panel">
                          <div class="media me-2">
                            <img
                              alt="image"
                              width="50"
                              src="https://koki.dexignzone.com/xhtml/images/avatar/1.jpg" />
                          </div>
              ...
              <li class="nav-item dropdown notification_dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <div
                    id="DZ_W_Gifts"
                    class="widget-timeline dz-scroll p-3 style-1">
                    <ul class="timeline">
                      <li>
