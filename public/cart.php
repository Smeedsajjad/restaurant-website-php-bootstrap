...
<body>
    ...
    <main>
        ...
        if (!isset($_SESSION['user_id'])) {
            echo '<div class="alert text-center alert-warning">You are not logged in. Please log in to view your cart.</div>';
        } else {
            ...
            <section id="empty-cart" class="d-block"> <!-- Change d-none to d-block to show the section -->
                <div class="container">
                    <div class="row justify-content-center text-center">
                        ...
                        <div>
                            <a href="index.php?page=shop" class="btn bg-warning invers_btn text-capitalize mx-auto">Return to shop</a>
                        </div>
                    </div>
                </div>
            </section>
