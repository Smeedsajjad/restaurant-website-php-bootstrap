            ...
            <div class="card overflow-hidden">
              <div class="card-header media border-0 pb-0">
                <div class="media-body">
                  <h2 class="text-black">
                    56 <span class="text-success fs-14">+4%</span>
                  </h2>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="card overflow-hidden">
              <div class="card-header media border-0 pb-0">
                <div class="media-body">
                  <h2 class="text-black">
                    785 <span class="text-success fs-14">+2.7%</span>
                  </h2>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="card overflow-hidden">
              <div class="card-header media border-0 pb-0">
                <div class="media-body">
                  <h2 class="text-black">
                    56 <span class="text-danger fs-14">-3%</span>
                  </h2>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="card overflow-hidden">
              <div class="card-header media border-0 pb-0">
                <div class="media-body">
                  <h2 class="text-black">
                    $6231 <span class="text-danger fs-14">-3.7%</span>
                  </h2>
                  ...
                  <table class="table order-request">
                    <tbody>
                      <tr>
                          ...
                          <div class="media align-items-center">
                            ...
                            <div class="media-body">
                              <h5 class="mt-0 mb-2">
                                <a
                                  class="text-black"
                                  href="ecom-product-detail.html">Tuna Soup spinach with himalaya salt.</a>
                              </h5>
                        ...
                        <td>
                          <h5 class="mb-2 text-black wspace-no">
                            Jimmy Kueai
                          </h5>
                        ...
                        <td style="width: 100px">
                          <div
                            ...
                            <h4
                              class="mb-0 me-3 fs-20 text-black d-inline-block">
                              $7.4
                            </h4>
                            ...
                            <div class="media-body">
                              <h5 class="mt-0 mb-2">
                                <a
                                  ...
                                  class="text-black">Mozarella Pizza With Random Topping</a>
                              </h5>
                          ...
                          <div class="media align-items-center">
                            ...
                            <div class="media-body">
                              <h5 class="mt-0 mb-2">
                                <a
                                  href="ecom-product-detail.html"
                                  class="text-black">Sweet Cheezy Pizza for Kids Meal (Small
                                  Size)</a>
                              </h5>
                              <p class="mb-0 text-primary">#0010235</p>
                            </div>
                          ...
                          <div class="media align-items-center">
                            ...
                            <div class="media-body">
                              <h5 class="mt-0 mb-2">
                                <a
                                  href="ecom-product-detail.html"
                                  class="text-black">Tuna soup spinach with himalaya salt</a>
                              </h5>
                              <p class="mb-0 text-primary">#0010235</p>
                            </div>
                          </div>
                ...
                <div class="widget-media trending-menus">
                  <ul class="timeline">
                    <li>
                      <div class="timeline-panel">
                        <div class="media me-3">
                          <img alt="image" width="90" src="assets/images/pic8.jpg" />
                        ...
                        <div class="media-body">
                          <h5 class="mb-3">
                            <a
                              href="ecom-product-detail.html"
                              class="text-black">Chicken curry special with cucumber</a>
                          </h5>
                          <div
                            ...
                            <p class="mb-0">
                              Order
                              <strong class="text-black font-w500">89x</strong>
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <li>
                      <div class="timeline-panel">
                        <div class="media me-3">
                          <img alt="image" width="90" src="assets/images/pic4.jpg" />
                        ...
                        <div class="media-body">
                          <h5 class="mb-3">
                            <a
                              href="ecom-product-detail.html"
                              class="text-black">Watermelon juice with ice</a>
                          </h5>
                          <div
                            class="d-flex justify-content-between align-items-center">
                            ...
                            <p class="mb-0">
                              Order
                              <strong class="text-black font-w500">67x</strong>
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <li>
                      <div class="timeline-panel">
                        <div class="media me-3">
                          <img alt="image" width="90" src="assets/images/pic9.jpg" />
                        ...
                        <div class="media-body">
                          <h5 class="mb-3">
                            <a
                              href="ecom-product-detail.html"
                              class="text-black">Italiano pizza with garlic</a>
                          </h5>
                          <div
                            class="d-flex justify-content-between align-items-center">
                            ...
                            <p class="mb-0">
                              Order
                              <strong class="text-black font-w500">59x</strong>
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <li>
                      <div class="timeline-panel">
                        <div class="media me-3">
                          <img alt="image" width="90" src="assets/images/pic6.jpg" />
                        ...
                        <div class="media-body">
                          ...
                          <div
                            ...
                            <p class="mb-0">
                              Order
                              <strong class="text-black font-w500">49x</strong>
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="timeline-panel">
                        ...
                        <div class="media-body">
                          <h5 class="mb-3">
                            <a
                              href="ecom-product-detail.html"
                              class="text-black">Medium Spicy Spagethi Italiano</a>
                          </h5>
                          <div
                            class="d-flex justify-content-between align-items-center">
    ...
    <div class="footer">
      <div class="copyright">
        <p>
          ...
          <a href="/" target="_blank">DexignZone</a> 2023
        </p>
      </div>
    </div>
    <!--**********************************
